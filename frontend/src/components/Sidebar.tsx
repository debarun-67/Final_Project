...
const Sidebar: React.FC<SidebarProps> = ({ role }) => {
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 h-[calc(100vh-64px)] p-4 flex flex-col gap-2 sticky top-16">
      ...
      <div className="mt-auto pt-4 border-t border-slate-100">
        <NavLink
          to="/settings"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-500 hover:bg-slate-50 hover:text-slate-800 transition-all font-medium text-sm"
        >
          <Settings size={20} />
          Settings
        </NavLink>
