...
function processFile(filePath) {
  ...
  content = content.replace(/\bborder-blue-[1-4]00\b/g, 'border-black');

  // Text color simplicity
  content = content.replace(/\btext-slate-[5-9]00\b/g, 'text-black');
  content = content.replace(/\btext-gray-[5-9]00\b/g, 'text-black');
  
  // Hover effects simple
  content = content.replace(/\bhover:bg-slate-[1-3]00\b/g, 'hover:bg-gray-100');
  content = content.replace(/\bhover:bg-gray-[1-3]00\b/g, 'hover:bg-gray-100');
